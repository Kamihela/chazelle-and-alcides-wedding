    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="relative p-5">
        ...
        <p className="font-gilda mb-3 h-16 font-normal text-xs text-justify text-gray-400">
          The guest reception at Bukovszki Estate begins at 5:00 PM. The civil ceremony starts at 5:30 PM, followed by a photo session for guests from 6:30 PM. Dinner will begin at 8:00 PM.
        </p>
        <button
          onClick={openModal}
