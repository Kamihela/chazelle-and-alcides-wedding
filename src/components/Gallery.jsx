    ...
    <section id="gallery" className="bg-white">
      <div className="pt-20 pb-10 lg:pb-20 flex flex-col gap-4 items-center justify-center">
        <h1 className="relative uppercase font-gilda text-4xl m-4 text-custom-pink">
          <img
            className="absolute -top-8 left-16 h-12"
            src={miniLeaves}
            alt="miniLeaves"
          />
          Galéria
      ...
      {isModalOpen && (
        ...
        >
          <div className="modal-content relative p-4 rounded-lg md:max-w-[60%] mx-auto">
            <div
              onClick={prevImage}
              className="cursor-pointer select-none absolute top-1/2 md:-mt-6 left-5 md:-left-12 text-2xl md:text-6xl text-zinc-400"
            >
              <FaAngleLeft />
            </div>
            <div
              onClick={prevImage}
              className="cursor-pointer absolute left-0 h-[96%] w-1/2 bg-opacity-100 z-1000"
            ></div>
            <img
            ...
            <div
              onClick={nextImage}
              className="cursor-pointer absolute right-0 top-4 h-[96%] w-1/2 bg-opacity-100 z-1000"
            ></div>

            <div
              onClick={nextImage}
              className="cursor-pointer select-none absolute top-1/2 md:-mt-6 right-5 md:-right-12 text-2xl md:text-6xl text-zinc-400"
            >
              <FaAngleRight />
            </div>
          </div>
